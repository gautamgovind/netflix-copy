...
import { HandThumbUpIcon, PlusIcon, XMarkIcon, ChevronDoubleDownIcon, ChevronDoubleUpIcon } from '@heroicons/react/24/outline';
...
const Modal = () => {
  ...
  return (
    ...
    >
        <>
            <button className='modalButton absolute right-5 top-5 !z-40 h-9 w-9 bg-[#181818] border-none hover:bg-[#181818]'>
            ...
            <div className='relative pt-[56.25%]'>
                ...
                <div className='absolute bottom-0 flex w-full items-center justify-center'>
                    ...
                    <button className='modalButton' onClick={()=> setMuted(!muted)}>
                        {muted ? (<ChevronDoubleDownIcon className='h-7 w-7' />) : (<ChevronDoubleUpIcon className='h-7 w-7' />)}
                    </button>
                </div>
            </div>
