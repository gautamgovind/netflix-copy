...
const Login = () => {
  ...
  return (
    <div className="relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent">
      ...
      >
        <h1 className="text-4xl font-semobold">Sign In</h1>
        <div className="space-y-4">
          ...
          {errors.email && <p className="p-1 text-[13px] font-light text-orange-500">Email is required</p>}
          ...
          {errors.password && <p className="p-1 text-[13px] font-light text-orange-500">Password is required</p>}
        </div>
